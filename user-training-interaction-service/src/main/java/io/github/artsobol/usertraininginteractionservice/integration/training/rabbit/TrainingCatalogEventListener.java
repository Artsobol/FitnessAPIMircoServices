package io.github.artsobol.usertraininginteractionservice.integration.training.rabbit;
...
import io.github.artsobol.usertraininginteractionservice.integration.training.projection.TrainingCatalogProjectionService;
...
public class TrainingCatalogEventListener {
    ...
    @RabbitListener(queues = RabbitTopology.USER_TRAINING_INTERACTION_TRAINING_EVENTS_QUEUE)
