package io.github.artsobol.usertraininginteractionservice.feature.training.rating.service;

import io.github.artsobol.common.exception.http.NotFoundException;
import io.github.artsobol.usertraininginteractionservice.feature.training.rating.dto.request.CreateTrainingRatingRequest;
import io.github.artsobol.usertraininginteractionservice.feature.training.rating.dto.request.UpdateTrainingRatingRequest;
import io.github.artsobol.usertraininginteractionservice.feature.training.rating.dto.response.TrainingRatingResponse;
import io.github.artsobol.usertraininginteractionservice.feature.training.rating.entity.TrainingRating;
import io.github.artsobol.usertraininginteractionservice.feature.training.rating.mapper.TrainingRatingMapper;
import io.github.artsobol.usertraininginteractionservice.feature.training.rating.repository.TrainingRatingRepository;
import io.github.artsobol.usertraininginteractionservice.integration.training.client.TrainingServiceClient;
